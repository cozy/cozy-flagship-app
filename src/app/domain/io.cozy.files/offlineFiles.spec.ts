...
describe('offlineFiles', () => {
  ...
  describe('downloadFile', () => {
    it('should download file if not existing', async () => {
      ...
      mockFileFromConfiguration(null)
      const file = {
        _id: 'SOME_FILE_ID',
        name: 'SOME_FILE_NAME'
...
const mockFileFromConfiguration = (file: OfflineFile | null): void => {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-call
  getOfflineFileFromConfiguration.mockResolvedValue(file)
}

const mockRemoteFile = (file: RemoteFile): void => {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-call
  getFileById.mockResolvedValue(file)
}

const mockDownloadUrl = (url: string): void => {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-call
  getDownloadUrlById.mockResolvedValue(url)
}
